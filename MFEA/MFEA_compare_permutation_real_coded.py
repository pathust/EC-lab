...
class MFEA_2_Problem:
    ...
    def run(self):
        ...
        self.history_best_1.append(best_1.fitness)
        self.history_best_2.append(best_2.fitness)
        for _ in range(self.num_generation):
            new_pop1, new_pop2 = [], []
...
class Experiment:
    ...
    def run(self):
        ...
        return result, algorithm.history_best_1, algorithm.history_best_2
...
experiments = [
    {
        ...
        "exp": Experiment(
            MFEA_2_Problem, [TSP, TSP], range(1),
...
for e in experiments:
    ...
    result, h1, h2 = e["exp"].run()
    hist[e["name"]] = {"eil51": h1, "eil101": h2}

# Plot: eil51
plt.figure()
plt.plot(hist["eil51-eil101-permutation"]["eil51"], label="Permutation (eil51)")
plt.plot(hist["eil51-eil101-real-coded"]["eil51"], label="Real-coded (eil51)")
...
plt.tight_layout()
plt.savefig("MFEA/images/plot_eil51_permutation_vs_real_coded.png", dpi=150)

# Plot: eil101
plt.figure()
plt.plot(hist["eil51-eil101-permutation"]["eil101"], label="Permutation (eil101)")
plt.plot(hist["eil51-eil101-real-coded"]["eil101"], label="Real-coded (eil101)")
plt.xlabel("Generation")
plt.ylabel("Best fitness")
...
plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig("MFEA/images/plot_eil101_permutation_vs_real_coded.png", dpi=150)
# plt.show()
